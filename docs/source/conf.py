# -*- coding: utf-8 -*-
#
# datalad_container documentation build configuration file, created by
...
project = u'Datalad for containerized environments'
...
htmlhelp_basename = 'datalad_containerdoc'
...
latex_documents = [
  (master_doc, 'datalad_container.tex', u'datalad_container Documentation',
